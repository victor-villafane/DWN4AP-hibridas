...
export function crearListadoProductos(productos) {
  ...
  productos.forEach((producto) => {
    html += `<li> ${producto.modelo} <a href="/productos/${producto.id}" >Ver</a> | <a href="/productos/modificar/${producto.id}" >editar</a>  </li>`;
  });
  html += "</ul>";
...
export function formularioModificarProducto(producto){
  let html = "<form action='/productos/modificar' method='post'>"
