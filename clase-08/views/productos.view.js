...
export function crearListadoProductos(productos) {
  ...
  productos.forEach((producto) => {
    html += `<li> ${producto.modelo} <a href="/productos/${producto.id}" >Ver</a> | <a href="/productos/modificar/${producto.id}" >editar</a> | <a href="/productos/eliminar/${producto.id}" >eliminar</a> </li>`;
  });
  html += "</ul>";
